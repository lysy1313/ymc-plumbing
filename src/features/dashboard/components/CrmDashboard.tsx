...
export function CrmDashboard() {
  ...
  return (
    <main className="min-h-screen bg-[#f6f8fb]">
      <header className="border-b border-slate-200 bg-slate-600 px-6 py-2">
        <div className="mx-auto flex max-w-6xl items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-slate-100">Lead to Job Flow</span>
          </div>
      ...
      <section className="mx-auto grid max-w-6xl gap-6 px-6 py-5 lg:grid-cols-[0.9fr_1.4fr]">
